...
public class MembersDAOImpl implements Members {
    ...
    @Override
    public MemberDTO memberSearch(String memId) {
    ...
    // 회원 가입, 수정 시 조회 용도(controller에서 boolean 반환으로 바꿔서 보안 높이기)
    public MemberDTO memberSearchEmail(String email) {
        MemberDTO result = null;
    ...
    // 회원 가입, 수정 시 조회 용도(controller에서 boolean 반환으로 바꿔서 보안 높이기)
    public MemberDTO memberSearchPhone(String phone) {
        MemberDTO result = null;
